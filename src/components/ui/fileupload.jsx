  ...
  return (
    <Card>
      <CardHeader className="flex-row flex items-center space-y-0">
        ...
        <div>
          <CardTitle className="text-lg font-semibold">Upload Your File</CardTitle>
          <CardDescription className="text-sm text-gray-500">Select a file to upload.</CardDescription>
        </div>
      </CardHeader>
      <CardContent>
        <div className="border-2 border-dashed border-muted rounded-lg h-52 px-2 flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-semibold mb-4 mt-4">Nunc scelerisque viverra mauris in aliquam</p>
          <p className="text-sm text-muted-foreground mb-4">Massa massa ultricies mi quis hendrerit.</p>
